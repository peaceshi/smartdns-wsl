...
process(){
    # Set Global Var
    BASE_URL='https://cdn.jsdelivr.net/gh/gfwlist/gfwlist@master/gfwlist.txt'
...
ipset=/\1/'$IPSET_NAME'#g' > $CONF_TMP_FILE
            ...
            sort -u $DOMAIN_FILE | $SED_ERES 's#(.+)#domain-rules /\1/ -nameserver gfwlist -speed-check-mode none#g' > $CONF_TMP_FILE
        fi
